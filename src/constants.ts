...
export const PERSONAL_INFO = {
  ...
  cgpa: "3.92",
  socials: {
    github: "https://github.com/developersajid",
    linkedin: "https://linkedin.com/in/developersajid",
    facebook: "https://facebook.com/developersajid",
...
export const PROJECTS: Project[] = [
  {
    ...
    description: "Lead Researcher for a state-of-the-art Deep Learning framework for mango variety classification, achieving 98.33% accuracy with integrated Explainable AI (XAI).",
  ...
  },
  {
    id: "med-fusion-net",
    title: "MedFusionNet",
    description: "A hybrid framework utilizing YOLO and SAM 2 for automated disease detection and report generation from radiology images (Chest X-rays).",
    tech: ["YOLO v8", "SAM 2", "PyTorch", "Medical AI"],
    image: "https://images.unsplash.com/photo-1516549655169-df83a0774514?auto=format&fit=crop&q=100&w=1600",
    link: "#",
    github: "#"
  },
  {
    ...
    description: "A productivity-focused mobile application built with Flutter helping thousands of students generate academic cover pages instantly.",
    tech: ["Flutter", "Dart", "Riverpod", "Firebase"],
    image: "https://images.unsplash.com/photo-1517694712202-14dd9538aa97?auto=format&fit=crop&q=100&w=1600",
    link: "#",
    github: "#"
  }
];
...
export const RESEARCH_PAPERS: ResearchPaper[] = [
  {
    ...
    abstract: "Published in Elsevier's Data in Brief (Volume 59, 2025). Contributing a robust dataset for agricultural computer vision and variety classification.",
    date: "2025",
    links: { 
      paper: "https://www.sciencedirect.com/science/article/pii/S2352340925007590"
    }
  }
];
...
export const SKILLS = {
  ...
  languages: ["Bengali (Native)", "English (Professional)", "Japanese (Learning)"]
};
